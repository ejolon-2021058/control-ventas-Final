...
const getProductosMenosVendidos = async (req = request, res = response) => {

    //condiciones del get
    const query = { ventas: { $lte: 99 } };
    ...
    res.json({
        msg: 'Lista de productos MENOS Vendidos ',
        listaProductos
    });
...
const getProductoAgotado = async (req = request, res = response) => {
    ...
    res.json({
        msg: 'Lista de productos NO DISPONIBLES - AGOTADOS',
        listaProductos
    });
