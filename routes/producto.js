...
//Controllers
const { postProducto, putProducto, deleteProducto, getProductos, getProductoPorId, getProductosMasVendidos, getProductosMenosVendidos, getProductoDisponible, getProductoAgotado } = require('../controllers/producto');
...
router.get('/productosMenosVendidos', getProductosMenosVendidos);
router.get('/productoAgotado', getProductoAgotado);
